            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      const Icon(Icons.verified_user, size: 75, color: Colors.orange),
                      const SizedBox(height: 12),
                      ...
                      GestureDetector(
                        onTap: () => Navigator.pushNamed(context, (mode == "forgot" ? '/forgotPassword' : '/login')),
                        child: Text(
                          "Back to ${(mode == "forgot" ? 'Forgot Password?' : 'Login?')}",
