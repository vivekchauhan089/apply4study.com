...
export default function Livguard100() {
  ...
  const handleClose = () => setOpen(false);
   const [value, setValue] = React.useState(1);
    ...
    const rate=3.5;
    const gst=18;
     const price=value*100000;
     const t=36;
   
    // const investAmount=value*price;
  ...
  return (
    <div>
          ...
          <div className="row">
            ...
            >
              <div className="investment-detail">
                ...
                <p >Select the number of 100AH Battery </p>
      ...
      />
                ...
                <p className="deposit" style={{marginBottom:"12px"}}>₹ Z more than Fixed Returns</p>
                <a 
        ...
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="mt-5">
            ...
            This investment opportunity involves leasing out Livguard 100 AH Lithium ion battery to Mooving
