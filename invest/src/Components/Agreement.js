...
export default function Agreement() {
  ...
  return (
    ...
    <div style={{backgroundColor:"#000", position:"absolute",width:"100%",height:"140vh"}}>
       ...
       {show &&  <Modal
                              ...
                              >
                                <Fade in={open}>
                                  <Box>
                                    <div className=' '>
                                    {/* <FontAwesomeIcon icon="fa-sharp fa-solid fa-file-invoice-dollar" /> */}
                                   <Alert style={{backgroundColor:"#F47920" , fontWeight:"600" , color:"white"}}>Payment link will be sent shortly.    <button className='btn btn-success' onClick={()=>{navigate('/investor')}}>Okay</button> </Alert>
                                    
                                     </div>
                                  </Box>
                                </Fade>
                              </Modal>}
        <div className='agreement-content' style={{marginTop:"50px"}}>
         ...
         <Tabs>
          ...
          <div class="acceptance"  style={{marginTop:'20px'}}>
              ...
              <input type="checkbox" class="checkbox"  onChange={(e)=>{setCheckbox(e.target.checked)}}></input>
              <span class="check-label" > I have read and agree to the <u>Terms and Condition</u> and <u>Privacy Policy</u></span>             
          </div>
          <button className="btn btn-success" onClick={submit} disabled={!checkbox}>Accept</button>
        
          <button style={{margin:"30px" ,color:"#808080"}} onClick={()=>{navigate("/investor")}}>Decline</button>

          {/* <button style={{margin:"30px" ,color:"#808080", fontWeight:"700"}}  onClick={onButtonClick}>Download PDF</button> */}
          <Link to="/agreement.pdf" style={{margin:"30px" ,color:"#808080", fontWeight:"700"}}  target="_blank" download>Download PDF</Link>
