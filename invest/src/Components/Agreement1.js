        ...
        <div className='agreement-content'>
         ...
         <Tabs>
          ...
          <div class="acceptance"  style={{marginTop:'20px'}}>
            ...
            <div class="mt-3 mb-3">
              <label for="exampleFormControlTextarea1"  className="">Add Your digital signatures here</label> 
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea> 
            </div>             

            <div className='mt-3 '>
              <button className='success-btn' onClick={submit}>Accept and continue</button>
              <button className='decline-btn m-5' onClick={()=>{navigate("/assetdetail")}}>Decline</button>
           
{/* 
   <button className=' success-btn m-5' style={{float:"right", fontWeight:"600", border:"1px solid #eee" , color:"#101010" , backgroundColor:"transparent"}}>Download Pdf<i className='fa fa-download'></i></button>
                <div className=' ' style={{marginTop:'20px'}}>
                  <button className='success-btn' onClick={()=>{setShow(true)}}>Accept and continue</button>
                  {/* <button className='decline-btn m-2'>Decline</button>
                  <button className=' success-btn m-2' style={{float:"right", fontWeight:"600", border:"1px solid #eee" , color:"#101010" , backgroundColor:"transparent"}}>Download Pdf<i className='fa fa-download'></i></button> */}
                {/* </div>  */}
            </div>
